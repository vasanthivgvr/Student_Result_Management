...
public class studentAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 226, 180, 30));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, 160, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_management_portal/r5.jpg"))); // NOI18N
...
try{
  ...
  // String query = "select * from result where result.rollno ='\"+rollno+'";
